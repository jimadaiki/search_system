        ...
        if(isset($_POST['subButton'])){
            ...
            /*検索結果表示*/
                ...
                foreach ($result as $key => $value) {
                    ...
                    /*検索後の顔写真と名前*/
                    echo '<a data-target="modal_'.$value["id"].'" class="modal-open"><img src="'.$value["face_img"].'"></a>';
                    ...
                    $group_name = mysql_fetch_array($result1, 0);


                    echo '<div class="detail">';
                    echo '<h5>所属グループ</h5>';
                    echo '<span class="group">　'.$group_name["group_name"].'　'.$value["no"].'期生</span><br>';
